"""
Genera tabla y visualización para los resultados de 30 runs.
"""
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt

results = pd.read_csv('experiment_results_30runs.csv')
...
with open('results_comparison_30runs.md', 'w') as f:
    f.write('\n'.join(md_lines))

print("✅ Tabla Markdown guardada en: results_comparison_30runs.md")
...
plt.tight_layout()
plt.savefig('results_comparison_30runs.png', dpi=200, bbox_inches='tight')
plt.close()

print("✅ Gráfico guardado en: results_comparison_30runs.png")
